...
CONTAINER_PATHS="sandbox-valg-rq5"

SCRIPT_PATH="sandbox-valg-rq5/home/Valg/tracemop/scripts"
RESULTS_DIR="results-valg-rq5"
OUTPUT_DIR="$SCRIPT_PATH/outputs-rq5"
...
for entry in "${projects[@]}"; do
    ...
    export PATH=$(pwd)/sandbox-valg-rq5/home/Valg/apache-maven/bin:$(pwd)/sandbox-valg-rq5/usr/lib/jvm/java-8-openjdk/bin:$(pwd)/sandbox-valg-rq5/home/Valg/aspectj-1.9.7/bin:$PATH
    export CLASSPATH=$(pwd)/sandbox-valg-rq5/home/Valg/aspectj-1.9.7/lib/aspectjtools.jar:$(pwd)/sandbox-valg-rq5/home/Valg/aspectj-1.9.7/lib/aspectjrt.jar:$(pwd)/sandbox-valg-rq5/home/Valg/aspectj-1.9.7/lib/aspectjweaver.jar
